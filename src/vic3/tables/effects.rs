...
const SCOPE_EFFECT: &[(Scopes, &str, Effect)] = &[
    ...
    (Scopes::Container, "add_tag", Identifier("tag")),
    ...
    (Scopes::None, "add_to_global_variable_map", Vb(validate_variable_map)),
    (Scopes::all(), "add_to_list", Vbv(validate_add_to_list)),
    (Scopes::None, "add_to_local_variable_list", Vb(validate_add_to_variable_list)),
    (Scopes::None, "add_to_local_variable_map", Vb(validate_variable_map)),
    ...
    (Scopes::None, "add_to_variable_map", Vb(validate_variable_map)),
    ...
    (Scopes::None, "clear_global_variable_map", Identifier("variable map name")),
    (Scopes::None, "clear_local_variable_list", Identifier("list name")),
    (Scopes::None, "clear_local_variable_map", Identifier("variable map name")),
    (Scopes::Container, "clear_name", Yes),
    (Scopes::Country, "clear_ownership_transfer_fleet", Yes),
    (Scopes::Container, "clear_parent", Yes),
    (Scopes::None, "clear_saved_scope", Identifier("scope name")),
    (Scopes::Country, "clear_scaled_debt", ScriptValue),
    (Scopes::Container, "clear_tags", Yes),
    (Scopes::None, "clear_variable_list", Identifier("list name")),
    (Scopes::None, "clear_variable_map", Identifier("variable map name")),
    ...
    (Scopes::None, "create_container", Vb(validate_create_container)),
    ...
    (Scopes::Container, "destroy_container", Yes),
    ...
    (Scopes::None, "remove_from_global_variable_map", Vb(validate_variable_map)),
    (Scopes::all_but_none(), "remove_from_list", Vv(validate_remove_from_list)),
    (Scopes::None, "remove_from_local_variable_map", Vb(validate_variable_map)),
    (Scopes::None, "remove_from_variable_map", Vb(validate_variable_map)),
    ...
    (Scopes::Container, "remove_tag", Identifier("tag")),
    ...
    (Scopes::Container, "set_name", Vv(validate_set_name)),
    ...
    (Scopes::Container, "set_parent", Scope(Scopes::non_primitive())),
