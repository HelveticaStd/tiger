&[
    ...
    ("GetCoastalBuildingTypesList", Args::Args(&[]), CString),
    ...
    ("GetContainer", Args::Args(&[DType(Unknown)]), Vic3(ScriptContainer)),
    ...
    ("GetNumCoastalBuildingTypes", Args::Args(&[]), int32),
    ...
    ("GetSelectedFleetsMissionRegionsBreakdown", Args::Args(&[]), CString),
    ("GetSelectedFleetsMissionSeaRegions", Args::Args(&[]), Unknown),
