&[
    ...
    ("AccessHoldingCharacter", Vic3(Building), Args::Args(&[]), Vic3(Character)),
    ...
    ("AccessScriptContainer", Scope, Args::Args(&[]), Vic3(ScriptContainer)),
    ...
    ("GetCountriesSearchBar", Vic3(DiplomaticOverviewPanel), Args::Args(&[]), Vic3(SearchBar)),
    ...
    ("GetEndDate", Vic3(TimedModifier), Args::Args(&[]), Date),
    ...
    ("GetFirstEnemyFleetOnMissionType", Vic3(NavalMissionMarker), Args::Args(&[DType(Unknown)]), Vic3(MilitaryFormation)),
    ("GetFirstFleetOnMissionType", Vic3(NavalMissionMarker), Args::Args(&[DType(Unknown)]), Vic3(MilitaryFormation)),
    ...
    ("GetHoldingCharacter", Vic3(Building), Args::Args(&[]), Vic3(Character)),
    ...
    ("GetMembersSearchBar", Vic3(PowerBlocPanel), Args::Args(&[]), Vic3(SearchBar)),
    ...
    ("GetNavalAdminBuildingTypeItem", Vic3(MilitaryFormation), Args::Args(&[]), Vic3(BuildingBrowserBuildingTypeItem)),
    ...
    ("GetParent", Vic3(ScriptContainer), Args::Args(&[]), Scope),
    ...
    ("GetPopSearchBar", Vic3(PopsOverviewPanel), Args::Args(&[]), Vic3(SearchBar)),
    ...
    ("GetScriptContainer", Scope, Args::Args(&[]), Vic3(ScriptContainer)),
    ...
    ("GetSearchBar", Vic3(BuildingBrowserPanel), Args::Args(&[]), Vic3(SearchBar)),
    ("GetSearchBar", Vic3(CompaniesPanel), Args::Args(&[]), Vic3(SearchBar)),
    ("GetSearchBar", Vic3(MarketPanel), Args::Args(&[]), Vic3(SearchBar)),
    ("GetSearchBar", Vic3(PoliticsPanel), Args::Args(&[]), Vic3(SearchBar)),
    ("GetSearchBar", Vic3(PopBrowserPanel), Args::Args(&[]), Vic3(SearchBar)),
    ("GetSearchBar", Vic3(PopsOverviewPanel), Args::Args(&[]), Vic3(SearchBar)),
    ("GetSearchBar", Vic3(TechTreePanel), Args::Args(&[]), Vic3(SearchBar)),
    ...
    ("GetSpawnRegion", Vic3(ShipConstruction), Args::Args(&[]), Vic3(StrategicRegion)),
    ...
    ("GetStartDate", Vic3(TimedModifier), Args::Args(&[]), Date),
    ...
    ("GetStateValuePerspective", Vic3(State), Args::Args(&[]), Vic3(Country)),
    ...
    ("GetTimedModifier", Vic3(Country), Args::Args(&[DType(Unknown)]), Vic3(TimedModifier)),
    ...
    ("MakeScope", Vic3(ScriptContainer), Args::Args(&[]), Scope),
    ...
    ("sAmendmentType", TopScope, Args::Args(&[DType(Unknown)]), Vic3(AmendmentType)),
